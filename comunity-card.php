					...
					<div class="container-fluid">
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary fw-bold">Carta comunitaria</h6>
							</div>
							<div class="card-body">
								<form method="post" class="needs-validation" id="formLogin" novalidate>
									...
									<div class="row">
										...
										<div class="col-md-5">
											...
											<div class="mb-3">
												<label for="direccionRecomendador" class="form-label">Dirreci&#243;n <span class="text-danger">*</span></label>
												<input type="text" name="direccionRecomendador" class="form-control" id="direccionRecomendador" required />
												<div class="invalid-feedback">
													La dirreci&#243;n es obligatoria
												</div>
											</div>
										</div>
										<div class="col-md-5">
											...
											<div class="mb-3">
												<label for="tiempoConocidos" class="form-label">
													Tiempo en la comunidad <span class="text-danger">*</span>
												</label>
												<input
													type="number"
										...
										<div class="col-md-12">
											<div class="mb-3 mt-2 d-flex justify-content-center align-items-center">
												<button class="btn btn-primary text-center">Generar carta familiar</button>
											</div>
										</div>
									</div>
								</form>
